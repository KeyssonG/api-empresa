...
public class CompanyRepository {
    ...
    private static final String INSERT_COMPANY = """
        INSERT INTO companies (name, cnpj, numero_conta, password, username, status, consumer_id)
        VALUES (?, ?, ?, ?, ?, ?, ?)
        """;
    ...
    public void save(String name, String cnpj, int numeroConta, String password, String username, int status) {
        ...
        jdbcTemplate.update(INSERT_COMPANY, name, cnpj, numeroConta, password, username, status, consumerId);
    }
}
