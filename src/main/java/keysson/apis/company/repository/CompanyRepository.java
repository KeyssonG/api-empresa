package keysson.apis.company.repository;
...
public class CompanyRepository {
    ...
    private static final String INSERT_COMPANY = """
        INSERT INTO companies (name, cnpj, numero_conta, password, status, consumer_id)
        VALUES (?, ?, ?, ?, ?, ?)
        """;
    ...
    public void save(String name, String cnpj, int numeroConta, String password, int status) {
        UUID consumerId = UUID.randomUUID();
        jdbcTemplate.update(INSERT_COMPANY, name, cnpj, numeroConta, password, status, consumerId);
    }
}
